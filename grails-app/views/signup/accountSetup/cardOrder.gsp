...
<g:form action="accountSetup">
  <div class="section mgn-bottom-20">
    ...
    <div class="content-block apps-colorbox1 mgn-bottom-10">
      <div class="apps-content-block-inner">
        <div class="apps-float-40"><label><g:radio value="helpdesk" name="cardpickup"/><g:message code="cardOrder.helpdesk.label"/></label></div>
        <div class="apps-float-50"><g:message code="cardOrder.helpdesk.desc"/></div>
        <div class="clear-float"></div>
      </div>
      <g:if test="${addrVo != null}">
        <div class="apps-content-block-inner">
          <div class="apps-float-40"><label><g:radio value="defaultAddress" name="cardpickup" checked="checked"/><g:message code="cardOrder.permAddr"/></label></div>
      ...
      <div class="apps-content-block-inner">
        <div class="apps-float-40"><label><g:radio value="otherAddress" name="cardpickup"/><g:message code="cardOrder.otherAddr.label"/></label></div>
      ...
      <div class="apps-content-block-inner">
        ...
        <div class="apps-float-35"><g:textField name="coadr"/></div>
      </div>
      <div class="clear-float"></div>
      <div class="apps-content-block-inner">
        <div class="apps-float-40">&nbsp;</div>
        <div class="apps-float-20"><g:message code="address.street.label"/></div>
        <div class="apps-float-35"><g:textField name="gatadr"/></div>
      </div>
      <div class="clear-float"></div>
      <div class="apps-content-block-inner">
        <div class="apps-float-40">&nbsp;</div>
        <div class="apps-float-20"><g:message code="address.zip.label"/></div>
        <div class="apps-float-35"><g:textField name="postnr" size="6"/></div>
      </div>
      <div class="clear-float"></div>
      <div class="apps-content-block-inner">
        <div class="apps-float-40">&nbsp;</div>
        <div class="apps-float-20"><g:message code="address.location.label"/></div>
        <div class="apps-float-35"><g:textField name="ort"/></div>
      </div>
      <div class="clear-float">&nbsp;</div>
    </div>
  </div>
  ...
  <div class="section mgn-bottom-20">
    ...
    <div class="content-block apps-colorbox1 mgn-bottom-10">
      <div class="apps-content-block-inner">
        <div class="apps-float-40"><label><g:radio value="su" name="email" checked="checked"/><g:message code="emailChoice.su.label"/></label></div>
        <div class="apps-float-50">${mail}<br/><span class="apps-hint-text"><g:message code="emailChoice.su.help"/></span></div>
      </div>
      <div class="clear-float"></div>
      <div class="apps-content-block-inner">
        <div class="apps-float-40"><label><g:radio value="other" name="email"/><g:message code="emailChoice.other.label"/></label></div>
        <div class="apps-float-50"><g:textField name="otherEmail"/></div>
      </div>
      <div class="clear-float"></div>
