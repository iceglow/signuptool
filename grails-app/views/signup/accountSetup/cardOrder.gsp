...
<g:form action="accountSetup">
    ...
    <div class="content-block apps-colorbox1 mgn-bottom-10">
      <g:if test="${addrVo != null}">
        <div class="apps-content-block-inner">
          ...
          ${addrVo.gatadr}<br/>${addrVo.postnr} ${addrVo.ort}
          </div>
  ...
  <div class="section align-right"><g:submitButton name="cardbutton"
                                                   value="${g.message(code:'cardOrder.button.next.label')}"/></div>
</g:form>
